import sys
#sys.path.append('/home/kazutoshi/')  ##CHANGE THIS
#import combs
import os
import prody as pr
import numpy as np
...
#from combs.apps.transformation import get_rot_trans
#from combs.apps.cluster import _make_pairwise_rmsd_mat
...
path = '/home/gpu/SamS/Master/DualBundle/HetN2/loopsBA/'  ##CHANGE THIS
run_cluster(path)
