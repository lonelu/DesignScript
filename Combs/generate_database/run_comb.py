...
path_to_combs2 = '/wynton/home/degradolab/lonelu/GitHub_Design/Combs2/'
...
inpath_prody_dir = workdir + '/db_2p8A_0p35rfree_reduced_reps_biounits_prody/'
outdir = workdir + '/comb_all/'
path_to_probe_paths = workdir + 'probe_dict.pkl'
inpath_rotamer_dir = workdir + 'db_2p8A_0p35rfree_reduced_reps_biounits_rot/'
...
def main():
    ...
    _ind_first = ind_first
    ind_first = _ind_first*20
    ind_last = _ind_first*20 + 19
